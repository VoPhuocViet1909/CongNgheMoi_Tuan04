...
async function create(req, res) {
  try {
    ...
    req.session.flash = {
      type: "error",
      message: err.message || "Không tạo được sản phẩm.",
    };
...
async function update(req, res) {
  ...
  try {
    ...
    req.session.flash = {
      type: "error",
      message: err.message || "Không cập nhật được sản phẩm.",
    };
...
async function remove(req, res) {
  ...
  try {
    ...
    req.session.flash = {
      type: "success",
      message: "Đã xoá (soft delete) sản phẩm.",
    };
    res.redirect("/");
  } catch (err) {
    ...
    req.session.flash = {
      type: "error",
      message: err.message || "Không xoá được sản phẩm.",
    };
    res.redirect("/");
  }
}
